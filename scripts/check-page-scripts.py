...
def constants(src):
    for name in ("MATCH", "SELECTOR", "DESCRIBE", "SNAPSHOT", "REACH", "REF_STATE", "WATCH", "CHANGED", "QUIET", "BOX", "NAMED", "NEARBY", "FILLABLE", "ASSIGN", "RICH", "PICK"):
...
def main():
    ...
    for spliced in ("BOX", "NAMED", "NEARBY", "FILLABLE", "ASSIGN", "RICH", "PICK"):
